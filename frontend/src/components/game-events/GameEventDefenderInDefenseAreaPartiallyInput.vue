...
import {type GameEvent_DefenderInDefenseAreaPartiallyJson, type GameEventJson} from "@/proto/state/ssl_gc_game_event_pb";
...
const details = ref<GameEvent_DefenderInDefenseAreaPartiallyJson>(gameEvent.value.defenderInDefenseAreaPartially!)
